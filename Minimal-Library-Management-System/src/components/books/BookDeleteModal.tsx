  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-md bg-gray-300 max-h-[90vh] md:max-h-[85vh] p-0">
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-gradient-to-r from-sky-500 to-yellow-500 hover:from-sky-600 hover:to-yellow-600 text-white py-2 px-4 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:transform-none border-0"
                >
                  {isLoading ? (
