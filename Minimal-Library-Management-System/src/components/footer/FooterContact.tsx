...
const FooterContact = () => {
    return (
        <div className='container mx-auto mt-10 bg-[#FFD66B] '>
          <div className="grid lg:grid-cols-3 sm:grid-cols-1 mt-6 ml-4">
              <div className="flex mt-6 ">
               <FaPhoneVolume className="text-3xl text-[#4DA8DA]"/>
                   <div className="">
            ...
            <div className="flex mt-6 ">
               <MdMarkEmailUnread  className="text-3xl text-[#4DA8DA]"/>
                <div className="">
            ...
            <div className="flex mt-6 ">
               <GoLocation  className="text-3xl text-[#4DA8DA]"/>
                 <div className="">
