...
export interface UpdateBookRequest extends Partial<Omit<CreateBookRequest, "genre">>{
     id: string,
     genre?: Genre;
}
...
export const isApiSuccess = <T>(
 ...
 export const validateBook = (book: unknown) : book is IBook => {
 ...
 export const validateBorrowSummary = (
     ...
     const summaryBook = summary as Record<string, unknown>;
     return (
        summaryBook.book !== null &&
        typeof summaryBook.book === "object" &&
        typeof (summaryBook.book as Record<string, unknown>).title === "string" &&
        typeof (summaryBook.book as Record<string, unknown>).isbn === "string" &&
        typeof summaryBook.totalQuantity === "number"
     )
 }
